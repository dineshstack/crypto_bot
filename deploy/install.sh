...
echo "    sudo systemctl restart crypto-bot   # Restart"
echo "    journalctl -u crypto-bot -f         # Live logs"
echo "    tail -f $APP_DIR/logs/bot.log       # App logs"
echo ""
echo "  First run checklist:"
echo "    1. Verify .env has all API keys set"
echo "    2. Start with TESTNET=true first"
echo "    3. Send /start in Telegram"
echo "    4. Run ML training: /analyze (triggers on first cycle)"
echo "    5. Switch to TESTNET=false when ready for live trading"
echo ""
